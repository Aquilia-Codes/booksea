...
class FirestorePath { 
  ...
  static String tours(String companyId, String boatId) => 'company/$companyId/boats/$boatId/tours';
  //This is the path for a specific tour for a specific boat
  static String tour(String companyId, String boatId, String tourId) => 'company/$companyId/boats/$boatId/tours/$tourId';

  //This is the path for all the types of tours for a specific boat
  static String tourTypes(String companyId, String boatId) => 'company/$companyId/boats/$boatId/tourTypes'; 
  //This is the path for a specific type of tour for a specific boat 
  static String tourType(String companyId, String boatId, String tourTypeId) => 'company/$companyId/boats/$boatId/tourTypes/$tourTypeId';

  //This is the path for all groups for a specific tour
  static String groups(String companyId, String boatId, String tourId) => 'company/$companyId/boats/$boatId/tours/$tourId/groups';
  //This is the path for a specific group for a specific tour
  static String group(String companyId, String boatId, String tourId, String groupId) => 'company/$companyId/boats/$boatId/tours/$tourId/groups/$groupId';
  ...
  static String companyWithCodeField(String companyCode) => 'company?companyCode=$companyCode';
